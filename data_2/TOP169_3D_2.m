...
top3d169(90,30,40,0.2,3.0,3.0,150); %top3d169(nelx,nely,nelz,volfrac,penal,rmin,maxloop)
toc;
function [x, U, c, dc]=top3d169(nelx,nely,nelz,volfrac,penal,rmin,maxloop)
...
title('1');
 save  xPhys
 csvwrite('element_pseudo_density.csv',xPhys);
%  save xPhys0 xPhys
% load xPhys
% Top3dSTL_v3('MyTop3d.stl',xPhys);
% Top3dSTL_ISO('MyTop3d1.stl',xPhys);
save('xPhystu.mat','xPhys');
end
