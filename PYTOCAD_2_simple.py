...
if __name__ == '__main__':
    ...
    surface = list(Parallel(n_jobs=48)(delayed(CAD_reconstruction)(i, simple_vertices_result, pts_vt_result,
                simple_patch_index_result, quad_vt_result) for i in number_quad_list))  # Parallel
